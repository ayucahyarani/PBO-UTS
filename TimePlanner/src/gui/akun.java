...
public class akun extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 320, 100, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String usernameString = jTextField1.getText();
        String passwordString = new String(jPasswordField1.getPassword());

        try {
            int username = Integer.parseInt(usernameString);
            int password = Integer.parseInt(passwordString);
            Loginser login = new Loginser(username, password);

            boolean berhasil = login.registerUser();
